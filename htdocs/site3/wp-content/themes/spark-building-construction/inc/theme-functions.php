 ...
 */
add_action( 'init', 'spark_building_construction_remove_action');

function spark_building_construction_remove_action() {
...
*/
if (! function_exists( 'spark_building_construction_team' ) ):
    function spark_building_construction_team(){
                                ...
                                <figure>
                                    <?php
                                        if( !empty( $team_layout ) && $team_layout == 'layout_two') {
                                            ...
                                            the_post_thumbnail('spark-building-construction-team');
...
add_action('construction_light_action_team', 'spark_building_construction_team', 75);

/**
 *  Blog Section.
*/
if (! function_exists( 'spark_building_construction_blog' ) ):
    function spark_building_construction_blog(){
...
add_action('construction_light_action_blog', 'spark_building_construction_blog', 65);