...
function spark_building_construction_starter_content_setup(){

    add_theme_support( 'starter-content', array(
        'attachments' => array(
            'featured-image-home' => array(
                'post_title'   => __( 'Featured Image Homepage', 'spark-building-construction' ),
                'post_content' => __( 'Featured Image Homepage', 'spark-building-construction' ),
        ...
        'theme_mods'  => array(
            ...
            'construction_light_primary_color' => '#fc5e16',
            ...
            'construction_light_sliders' => json_encode( array(
                array(
                    ...
                    'button_link' => '#',
                    'button_link_one' => '',
                    'button_text' => esc_html__('Contact Us', 'spark-building-construction'),
                    'button_text_one' => '',
                ),
                ...
                array(
                    ...
                    'button_link' => '',
                    'button_link_one' => '',
                    'button_text' => esc_html__('Get Quote', 'spark-building-construction'),
                    'button_text_one' => '',
                ),
                array(
                    'image' => get_template_directory_uri() . '/assets/default/slider3.jpg',
        ...
        'nav_menus' => array(
            'menu-1' => array(
				'name' => __( 'Top Menu', 'spark-building-construction' ),
				'items' => array(
					'page_home',
					'page_about',
					'page_blog',
...
add_action( 'after_setup_theme', 'spark_building_construction_starter_content_setup', 20 );