            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 feature-list mb-3">
               <div class="box">
                  <div class="bottom-content">
                     ...
                     <h4><?php echo esc_html__('Call Us', 'spark-building-construction'); ?></h4>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 feature-list mb-3">
               <div class="box">
                  <div class="bottom-content">
                     ...
                     <h4><?php echo esc_html__('Email Us', 'spark-building-construction'); ?></h4>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 feature-list mb-3">
               <div class="box">
                  <div class="bottom-content">
                     ...
                     <h4><?php echo esc_html__('Address', 'spark-building-construction'); ?></h4>
                     <span>
