...
function construction_light_service_advance_content() {
    ...
    if (!empty($construction_light_services)) {
        foreach ($construction_light_services as $construction_light_service) {
            ...
            $link_text = !empty($construction_light_service->link_text) ? apply_filters('construction_light_translate_string', $construction_light_service->link_text, 'Service Block') : esc_html__('Read More', 'spark-building-construction');
