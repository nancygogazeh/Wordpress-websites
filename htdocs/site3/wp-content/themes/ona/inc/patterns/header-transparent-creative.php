...
return array(
	...
	'content'    => '
			...
			<div class="wp-block-column is-vertically-aligned-center ona-sm-down-order-2" style="flex-basis:60%"><!-- wp:navigation {"textColor":"background","overlayMenu":"mobile","layout":{"type":"flex","justifyContent":"right","orientation":"horizontal"}} -->
			...
			<!-- wp:navigation-link {"label":"Minimal","url":"#","kind":"custom","isTopLevelLink":false} /-->
			<!-- wp:navigation-link {"label":"Creative","url":"#","kind":"custom","isTopLevelLink":false} /-->
			<!-- wp:navigation-link {"label":"Online Store (Pro)","url":"#","kind":"custom","isTopLevelLink":false} /-->
