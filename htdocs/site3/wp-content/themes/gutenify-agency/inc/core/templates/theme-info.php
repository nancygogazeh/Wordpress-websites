						...
						<div class="gutenify-agency-header-left admin-col">
							<div class="gutenify-agency-card-header-button-group">
								...
								<a href="<?php echo admin_url( 'admin.php?page=gutenify-template-kits' ); ?>"
                                                class="gutenify-agency-admin-button" rel="noreferrer"><span class="dashicons dashicons-admin-customizer"></span> <?php esc_html_e( 'Template Kits', 'gutenify-agency' ); ?></a>
								<?php endif; ?>
								<?php if ( ! $gutenify_is_installed && ! $gutenify_is_active ) : ?>
								<a href="javascript:void(0);" class="gutenify-agency-admin-button gutenify-agency-install-gutenify"><span class="dashicons dashicons-admin-customizer"></span> <?php esc_html_e( 'Import template', 'gutenify-agency' ); ?> </a>
								<?php endif; ?>
								<?php if ( $gutenify_is_installed && ! $gutenify_is_active ) : ?>
								<a href="javascript:void(0);" class="gutenify-agency-admin-button gutenify-agency-activate-gutenify"><span class="dashicons dashicons-admin-customizer"></span> <?php esc_html_e( 'Import template', 'gutenify-agency' ); ?> </a>
								<?php endif; ?>
								<?php if ( $gutenify_is_active && ! class_exists( 'Gutenify_Pro' ) ) : ?>
								<a href="https://gutenify.com/pricing" class="gutenify-agency-admin-button" rel="noreferrer" target="_blank"><i
                                                        class="fa fa-paint-brush"></i> <?php esc_html_e( 'Get Gutenify Pro', 'gutenify-agency' ); ?> </a>
								<?php endif; ?>
								<a  href="https://gutenify.com/documentations/" class="gutenify-agency-admin-button premium-button"
                ...
                <div class="gutenify-agency-about-container subscribe-panel admin-grid-3">
                        <div class="admin-col">
                                <div class="gutentor-get-started-content">
                                        <h3><?php esc_html_e( 'Gutenify Template Kits', 'gutenify-agency' ); ?></h3>
                                        ...
                                        <ul>
                                                ...
                                                <li> <span class="dashicons dashicons-search"></span> <a
                                                                ...
                                                                rel="noreferrer"><?php esc_html_e( 'Browse Template Kits', 'gutenify-agency' ); ?></a></li>
												<?php endif; ?>
												<?php if ( ! defined('GUTENIFY_VERSION') ) : ?>
                                                <li> <span class="dashicons dashicons-search"></span> <a
                        ...
                        <div class="admin-col">
                                <div class="gutenify-agency-get-started-content">
                                        <h3><?php esc_html_e( 'Import Templates (Patterns)', 'gutenify-agency' ); ?></h3>
                                        <p><?php esc_html_e( 'From Edit screen of page/post, you can easily import Beautiful
                                                Templates', 'gutenify-agency' ); ?></p>
                                        <ul>
                                                <li> <span class="dashicons dashicons-welcome-learn-more"></span> <a
                                                                ...
                                                                Templates', 'gutenify-agency' ); ?></a></li>
                                                <li> <span class="dashicons dashicons-edit"></span> <a
                                                                href="<?php echo admin_url( 'post-new.php?post_type=page' ); ?>"
                                                                rel="noreferrer"><?php esc_html_e( 'Create page to add template', 'gutenify-agency' ); ?></a>
                                                </li>
                                        </ul>
                                </div>
                        </div>
                ...
                <div class="gutenify-agency-about-container gutenify-agency-compare-table">
                        <div class="admin-grid-1">
                                <h3>
									...
									<p class="gutenify-agency-compare-table-subtitle"><a href="https://gutenify.com/pricing/" target="__blank"><?php esc_html_e( 'Checkout all features', 'gutenify-agency' ); ?> <i class="dashicons dashicons-arrow-right-alt"></i></a></p>
                                <table>
                                        <thead>
                                                <tr>
                                                        <th>
                                        ...
                                        <tbody>
                                                ...
                                                <tr>
                                                        <td>
                                                                <?php esc_html_e( 'Premium templates kits', 'gutenify-agency' ); ?>
                                                                </th>
                                                ...
                                                <tr>
                                                        <td>
                                                                <?php esc_html_e( 'Premium Templates (Patterns)', 'gutenify-agency' ); ?>
                                                                </th>
                                                        <td><span class="dashicons dashicons-no"></span></th>
                                                        <td><span class="dashicons dashicons-yes"></span></th>
                                                </tr>
                ...
                <div class="feature-list">
                        <div class="gutenify-agency-about-container gutenify-about-content">
                                <div class="gutenify-agency-admin-card features">
                                        ...
                                        <ul class="gutenify-agency-options-features">
                                                ...
                                                <li><span class="dashicons dashicons-yes"></span>
												<?php esc_html_e( 'Template Kits', 'gutenify-agency' ); ?>   </li>
                                                <li><span class="dashicons dashicons-yes"></span>
                        ...
                        <div class="gutenify-agency-about-side">
                                ...
                                <div class="gutenify-agency-admin-card cart-two">
                                        ...
                                        <p><?php esc_html_e( 'We are always ready with all fix issues you stuck to ensure smoothly works with gutenify', 'gutenify-agency' ); ?></p><a href="https://gutenify.com/contact/"
		...
		<?php if ( defined('GUTENIFY_VERSION') && class_exists( 'Gutenify_Pro' ) ) : ?>
								<a href="<?php echo admin_url( 'admin.php?page=gutenify-template-kits' ); ?>"
                                                class="gutenify-agency-admin-button" rel="noreferrer"><i
                                                        class="fa fa-paint-brush"></i> <?php esc_html_e( 'Template Kits', 'gutenify-agency' ); ?></a>
								<?php endif; ?>
								<?php if ( ! defined('GUTENIFY_VERSION') || ! class_exists( 'Gutenify_Pro' ) ) : ?>
								<a href="https://gutenify.com/pricing" class="gutenify-agency-admin-button" rel="noreferrer" target="_blank"><i
                                                        class="fa fa-paint-brush"></i> <?php esc_html_e( 'Get Gutenify Pro', 'gutenify-agency' ); ?> </a>
