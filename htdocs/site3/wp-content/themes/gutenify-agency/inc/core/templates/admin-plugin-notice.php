...
<div class="notice notice-success is-dismissible gutenify-agency-admin-notice">
	<div class="gutenify-agency-admin-notice-wrapper">
		...
		<p><?php esc_html_e( 'We strongly recommend installing plugin: ', 'gutenify-agency' ); ?> <strong><?php esc_html_e( 'Gutenify', 'gutenify-agency' ); ?></strong></p>
		<p><strong><?php esc_html_e( 'Gutenify', 'gutenify-agency' ); ?></strong> <?php esc_html_e( 'provides multiple template kit and also add advance features to your site.', 'gutenify-agency' ); ?></p>
		<a href="<?php echo esc_url( admin_url( 'themes.php?page=gutenify-agency-info' ) ); ?>" class="gutenify-agency-admin-notice-primary-button"><?php esc_html_e( 'Get Templates', 'gutenify-agency' ); ?></a>
